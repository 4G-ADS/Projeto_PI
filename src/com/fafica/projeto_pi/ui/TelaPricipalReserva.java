...
public class TelaPricipalReserva extends JFrame {

	private JPanel contentPane;
	private static ArrayList<Solo> listaSolo = new ArrayList<>();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaPricipalReserva frame = new TelaPricipalReserva();
