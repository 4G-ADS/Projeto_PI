...
public class ControladorPlantaGrandePorte {
	...
	public void removerPlantaGrandePorte(int idPlantaGrande) throws Exception,PesquisadorNaoEncontradoException{
	...
	public PlantaGrandePorte procurarPlantaGrande(int idPlantaGrande) throws Exception,PesquisadorNaoEncontradoException{
