...
public class TesteListar2 {
	...
	Fachada fachada = Fachada.getInstace();
		...
		try {
//ok->		ArrayList<Instituicao> lista = fachada.listarInstituicao(1);
//ok->		ArrayList<NascenteAgua> listaAgua = fachada.listarNascente(4);
//ok->		ArrayList<Pesquisador> listaPesquisador = fachada.listarPesquisador(4);
