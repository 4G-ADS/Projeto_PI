...
public class ControladorAdministrador {
	...
	public void cadastrarAdministrardor(Administrador administrador) throws SQLException, IOException{
		System.out.println("Passando pela controladoraUsuario CadastrarUsuarioBDR");
	System.out.println(administrador);
		if(banco ==1){
			this.repositorioAdminstrador.cadastrarAdministrador(administrador);
		}else if (banco ==2){
		this.repositorioAdministradorIO.cadastrarAdministrador(administrador);
		}else if(banco ==3){
			this.repositorioAdministradorMAP.cadastrarAdministrador(administrador);
		}else if(banco ==4){
			this.repositorioAdministradorSET.cadastrarAdministrador(administrador);
		}
	}

	public ArrayList<Administrador> listarAdministrardor() throws SQLException, IOException{
	...
	public void editarAdministrardor(Administrador administrador) throws SQLException, IOException, AdministradorNaoEncontradoException{	
	...
	public void removerAdministrardor(int idAdministrador) throws SQLException, IOException, AdministradorNaoEncontradoException{
		...
		this.repositorioAdministradorIO.removerAdministrador(idAdministrador);
		}else if(banco ==3){
			this.repositorioAdministradorMAP.removerAdministrador(idAdministrador);
		}else if(banco ==4){
			this.repositorioAdministradorSET.removerAdministrador(idAdministrador);
		}
	}
	
	public void procurarAdministrardor(int idAdministrador) throws SQLException, IOException, AdministradorNaoEncontradoException{
		...
		this.repositorioAdministradorIO.procurarAdministrador(idAdministrador);
		}else if(banco ==3){
			this.repositorioAdministradorMAP.procurarAdministrador(idAdministrador);
		}else if(banco ==4){
			this.repositorioAdministradorSET.procurarAdministrador(idAdministrador);
		}
	}
